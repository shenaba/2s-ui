...
var messages = map[string]map[string]string{
	"en": {
		...
		"digest.maintenance": "stopped for maintenance",
	...
	"ru": {
		...
		"digest.maintenance": "остановлено для обслуживания",
	...
	"fa": {
		...
		"digest.maintenance": "متوقف برای نگهداری",
	...
	"vi": {
		...
		"digest.maintenance": "đã dừng để bảo trì",

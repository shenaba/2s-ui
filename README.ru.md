...
2S-UI — открытая панель управления [sing-box](https://github.com/SagerNet/sing-box), рассчитанная на развёртывание и эксплуатацию собственных прокси-сервисов. Настройка протоколов, правила маршрутизации, пользователи и подписки, статистика трафика собраны в одном интерфейсе — на шести языках и в двух темах; панель и ядро sing-box собраны в один бинарник, которого достаточно и для одной машины, и для кластера.

...
export default {
  ...
  setting: {
    ...
    webUriPathMismatch: "مسیر با «مسیر پایه» یکی نیست. این فیلد فقط مقصد هدایت است؛ برای جابه‌جایی پنل «مسیر پایه» را ویرایش کنید.",
    webUriPathBlocked: "مسیر «آدرس نهایی پنل» با «مسیر پایه» یکی نیست",
    webUriPathBlockedHint: "چیزی ذخیره نشد. «آدرس نهایی پنل» فقط مقصد هدایت پس از راه‌اندازی مجدد را تعیین می‌کند و مسیری را که پنل ارائه می‌دهد تغییر نمی‌دهد؛ ناهماهنگی شما را بدون راه بازگشت به یک ۴۰۴ می‌برد. آن‌ها را یکسان کنید: برای جابه‌جایی پنل «مسیر پایه» را ویرایش کنید، یا مسیر «آدرس نهایی پنل» را به {path} برگردانید.",
    ...
    subUriPathMismatch: "مسیر با «مسیر پیشفرض» یکی نیست. این فیلد فقط پایهٔ لینک کلاینت‌هاست؛ برای جابه‌جایی «مسیر پیشفرض» را ویرایش کنید.",
    subUriPathBlocked: "مسیر «آدرس نهایی سابسکریپشن» با «مسیر پیشفرض» یکی نیست",
    subUriPathBlockedHint: "چیزی ذخیره نشد. «آدرس نهایی سابسکریپشن» فقط پایهٔ لینک‌هایی است که به کلاینت‌ها داده می‌شود و مسیری را که اشتراک ارائه می‌دهد تغییر نمی‌دهد. ناهماهنگی خطای آشکاری نمی‌دهد: پنل درست کار می‌کند و همهٔ کلاینت‌ها بی‌صدا از به‌روزرسانی بازمی‌مانند. آن‌ها را یکسان کنید: برای جابه‌جایی «مسیر پیشفرض» را ویرایش کنید، یا مسیر «آدرس نهایی سابسکریپشن» را به {path} برگردانید.",

...
export default {
  ...
  setting: {
    ...
    webUriPathMismatch: "مسیر آن با «مسیر پایه» یکسان نیست. این فیلد فقط مقصد هدایت را تعیین می‌کند و مسیری را که پنل واقعاً ارائه می‌دهد تغییر نمی‌دهد؛ برای جابه‌جایی پنل، «مسیر پایه» را ویرایش کنید.",
    ...
    subUriPathMismatch: "مسیر آن با «مسیر پیش‌فرض» یکسان نیست. این فیلد فقط پایهٔ لینک‌هایی است که به کلاینت‌ها داده می‌شود و مسیری را که اشتراک ارائه می‌دهد تغییر نمی‌دهد؛ برای جابه‌جایی، «مسیر پیش‌فرض» را ویرایش کنید.",

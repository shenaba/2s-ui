...
export default {
  ...
  setting: {
    ...
    webUriInvalid: "باید یک نشانی کامل همراه با https:// باشد — این «مسیر پایه» نیست، آن را دست نزنید.",
    ...
    subUriInvalid: "باید یک نشانی کامل همراه با https:// باشد — این «مسیر پیشفرض» نیست، آن را دست نزنید.",

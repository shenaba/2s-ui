...
export default {
  ...
  setting: {
    ...
    webUriInvalid: "Нужен полный адрес вместе с https:// — это не «Базовый URI», его не трогайте.",
    ...
    subUriInvalid: "Нужен полный адрес вместе с https:// — это не «Путь по умолчанию», его не трогайте.",

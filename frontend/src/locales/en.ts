...
export default {
  ...
  setting: {
    ...
    webUriInvalid: "Must be a full address including https:// — this is not Base URI, leave that alone.",
    ...
    subUriInvalid: "Must be a full address including https:// — this is not Default Path, leave that alone.",

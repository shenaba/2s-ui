...
export default {
  ...
  setting: {
    ...
    webUriPathMismatch: "Đường dẫn khác «Đường dẫn gốc». Mục này chỉ đặt nơi chuyển hướng — muốn đổi, hãy sửa «Đường dẫn gốc».",
    webUriPathBlocked: "Đường dẫn «URI bảng điều khiển» không khớp «Đường dẫn gốc»",
    webUriPathBlockedHint: "Chưa lưu gì cả. «URI bảng điều khiển» chỉ quyết định nơi chuyển hướng sau khi khởi động lại, không đổi đường dẫn mà bảng điều khiển phục vụ — lệch nhau sẽ đưa bạn tới 404 và không còn đường quay lại. Hãy làm cho chúng khớp: sửa «Đường dẫn gốc» để di chuyển bảng điều khiển, hoặc đặt lại đường dẫn của «URI bảng điều khiển» về {path}.",
    ...
    subUri: "URI đăng ký",
    subUriPathMismatch: "Đường dẫn khác «Đường dẫn mặc định». Mục này chỉ đặt tiền tố liên kết gửi cho client — muốn đổi, hãy sửa «Đường dẫn mặc định».",
    subUriPathBlocked: "Đường dẫn «URI đăng ký» không khớp «Đường dẫn mặc định»",
    subUriPathBlockedHint: "Chưa lưu gì cả. «URI đăng ký» chỉ đặt tiền tố của liên kết gửi cho client, không đổi đường dẫn mà đăng ký thực sự phục vụ. Lệch nhau sẽ không báo lỗi ngay: bảng điều khiển vẫn chạy bình thường, còn mọi client lặng lẽ ngừng cập nhật. Hãy làm cho chúng khớp: sửa «Đường dẫn mặc định» để di chuyển, hoặc đặt lại đường dẫn của «URI đăng ký» về {path}.",

...
export default {
  ...
  setting: {
    ...
    webUriInvalid: "Phải là địa chỉ đầy đủ kèm https:// — đây không phải «Đường dẫn gốc», đừng sửa mục đó.",
    ...
    subUriInvalid: "Phải là địa chỉ đầy đủ kèm https:// — đây không phải «Đường dẫn mặc định», đừng sửa mục đó.",
